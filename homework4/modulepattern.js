//paternler icin addyosman sitesine bak.
const currencyModule = (function(){
    const data = {
      USD: {EUR: 0.82, GBP: 0.74, JPY: 0.74},
      EUR: {USD: 1.23, GBP: 0.91, JPY: 0.74},
      GBP: {USD: 1.35, EUR: 1.10, JPY: 0.74},
      JPY: {USD: 1.35, EUR: 1.10, GBP: 0.74}
    };
    ...
    const getCheckedFromTarget = () => {
        return document.querySelector("input[name='" + currencyFromInputName + "']:checked");
    };
  
    const getCheckedToTarget = () =>{
      return document.querySelector("input[name='" + currencyToInputName + "']:checked");
    }
...
//    direk initi cagirirsak return yapmadan kimse disaridan ulasamaz. init();
    return {
      init,     // init: init
